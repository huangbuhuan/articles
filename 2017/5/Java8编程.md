...
将流中的元素转换为另外一个元素。
	...
	#输入
	Stream<Integer> nums = Stream.of(18, 19 ,20);
	nums.map(num -> num + 100).forEach(System.out::println);
...
8. [Java 8新特性终极指南](http://www.importnew.com/11908.html#newFeatureOfJVM)
9. [《Java8实战》](https://book.douban.com/subject/25912747/)
10. [《Java8函数式编程》](https://book.douban.com/subject/26346017/)
